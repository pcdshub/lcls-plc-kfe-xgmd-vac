...
epicsEnvSet("LOCATION", "IOC:PLC:KFE:XGMD:VAC" )
...
epicsEnvSet("IPADDR",           "172.21.92.60")
epicsEnvSet("AMSID",            "172.21.92.60.1.1")
...
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=IOC:PLC:KFE:XGMD:VAC")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=IOC:PLC:KFE:XGMD:VAC")
